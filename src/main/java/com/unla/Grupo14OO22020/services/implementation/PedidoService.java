...
public class PedidoService implements IPedidoService{
	...
	public PedidoModel Insert(PedidoModel pedidoModel) {
		ProductoModel p = productoService.findByIdProducto(pedidoModel.getProducto().getIdProducto());
		pedidoModel.setTotal(pedidoModel.getCantidad()*p.getPrecio());
	...
	public PedidoModel Insert_2(PedidoModel pedidoModel) {
		...
		pedido.setTotal(pedido.getCantidad()*producto.getPrecio());
